...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2020 at 11:55 AM
...
INSERT INTO `defectdetail` (`runid`, `pipe_id`, `defect_id`, `defect_length`, `defect_breadth`, `defect_angle`, `defect_depth`, `type`, `x`, `y`) VALUES
(1, 5, 31, 94891, 92, 0, 0, 'system', 0, 1),
(3, 6, 32, 32806, 96, 0, 0, 'system', 0, 0),
(4, 7, 33, 131230, 95, 0, 0, 'system', 0, 1),
(5, 4, 49, 5, 36, 0, 0, 'manual', 1, 22),
(5, 9, 61, 8, 5, 0, 0, 'system', 8, 39);
...
--
ALTER TABLE `defectdetail`
  MODIFY `defect_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
