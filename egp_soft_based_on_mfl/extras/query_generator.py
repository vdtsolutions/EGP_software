...
def get_pipe(lower_sensitivity, upper_sensitivity, runid, start_index, end_index, pipe_id):
    print("lower_sensitivity and upper_sensitivity", lower_sensitivity, upper_sensitivity)
    """
    ...
    base_values = []
    base_values.append(int(config["F1H1"]))
    base_values.append(int(config["F1H2"]))
    base_values.append(int(config["F1H3"]))
    base_values.append(int(config["F1H4"]))
    # base_values.append(float(config["F1P1"]))
    base_values.append(int(config["F2H1"]))
    base_values.append(int(config["F2H2"]))
    base_values.append(int(config["F2H3"]))
    base_values.append(int(config["F2H4"]))
    # base_values.append(float(config["F2P2"]))
    base_values.append(int(config["F3H1"]))
    base_values.append(int(config["F3H2"]))
    base_values.append(int(config["F3H3"]))
    base_values.append(int(config["F3H4"]))
    # base_values.append(float(config["F3P3"]))
    base_values.append(int(config["F4H1"]))
    base_values.append(int(config["F4H2"]))
    base_values.append(int(config["F4H3"]))
    base_values.append(int(config["F4H4"]))
    # base_values.append(float(config["F4P4"]))
    base_values.append(int(config["F5H1"]))
    base_values.append(int(config["F5H2"]))
    base_values.append(int(config["F5H3"]))
    base_values.append(int(config["F5H4"]))
    # base_values.append(float(config["F5P1"]))
    base_values.append(int(config["F6H1"]))
    base_values.append(int(config["F6H2"]))
    base_values.append(int(config["F6H3"]))
    base_values.append(int(config["F6H4"]))
    # base_values.append(float(config["F6P2"]))
    base_values.append(int(config["F7H1"]))
    base_values.append(int(config["F7H2"]))
    base_values.append(int(config["F7H3"]))
    base_values.append(int(config["F7H4"]))
    # base_values.append(float(config["F7P3"]))
    base_values.append(int(config["F8H1"]))
    base_values.append(int(config["F8H2"]))
    base_values.append(int(config["F8H3"]))
    base_values.append(int(config["F8H4"]))
    # base_values.append(float(config["F8P4"]))
    base_values.append(int(config["F9H1"]))
    base_values.append(int(config["F9H2"]))
    base_values.append(int(config["F9H3"]))
    base_values.append(int(config["F9H4"]))
    # base_values.append(float(config["F9P1"]))
    base_values.append(int(config["F10H1"]))
    base_values.append(int(config["F10H2"]))
    base_values.append(int(config["F10H3"]))
    base_values.append(int(config["F10H4"]))
    # base_values.append(float(config["F10P2"]))
    base_values.append(int(config["F11H1"]))
    base_values.append(int(config["F11H2"]))
    base_values.append(int(config["F11H3"]))
    base_values.append(int(config["F11H4"]))
    # base_values.append(float(config["F11P3"]))
    base_values.append(int(config["F12H1"]))
    base_values.append(int(config["F12H2"]))
    base_values.append(int(config["F12H3"]))
    base_values.append(int(config["F12H4"]))
    # base_values.append(float(config["F12P4"]))
    base_values.append(int(config["F13H1"]))
    base_values.append(int(config["F13H2"]))
    base_values.append(int(config["F13H3"]))
    base_values.append(int(config["F13H4"]))
    # base_values.append(float(config["F13P1"]))
    base_values.append(int(config["F14H1"]))
    base_values.append(int(config["F14H2"]))
    base_values.append(int(config["F14H3"]))
    base_values.append(int(config["F14H4"]))
    # base_values.append(float(config["F14P2"]))
    base_values.append(int(config["F15H1"]))
    base_values.append(int(config["F15H2"]))
    base_values.append(int(config["F15H3"]))
    base_values.append(int(config["F15H4"]))
    # base_values.append(float(config["F15P3"]))
    base_values.append(int(config["F16H1"]))
    base_values.append(int(config["F16H2"]))
    base_values.append(int(config["F16H3"]))
    base_values.append(int(config["F16H4"]))
    # base_values.append(float(config["F16P4"]))
    base_values.append(int(config["F17H1"]))
    base_values.append(int(config["F17H2"]))
    base_values.append(int(config["F17H3"]))
    base_values.append(int(config["F17H4"]))
    # base_values.append(float(config["F17P1"]))
    base_values.append(int(config["F18H1"]))
    base_values.append(int(config["F18H2"]))
    base_values.append(int(config["F18H3"]))
    base_values.append(int(config["F18H4"]))
    # base_values.append(float(config["F18P2"]))
    base_values.append(int(config["F19H1"]))
    base_values.append(int(config["F19H2"]))
    base_values.append(int(config["F19H3"]))
    base_values.append(int(config["F19H4"]))
    # base_values.append(float(config["F19P3"]))
    base_values.append(int(config["F20H1"]))
    base_values.append(int(config["F20H2"]))
    base_values.append(int(config["F20H3"]))
    base_values.append(int(config["F20H4"]))
    # base_values.append(float(config["F20P4"]))
    base_values.append(int(config["F21H1"]))
    base_values.append(int(config["F21H2"]))
    base_values.append(int(config["F21H3"]))
    base_values.append(int(config["F21H4"]))
    # base_values.append(float(config["F21P1"]))
    base_values.append(int(config["F22H1"]))
    base_values.append(int(config["F22H2"]))
    base_values.append(int(config["F22H3"]))
    base_values.append(int(config["F22H4"]))
    # base_values.append(float(config["F22P2"]))
    base_values.append(int(config["F23H1"]))
    base_values.append(int(config["F23H2"]))
    base_values.append(int(config["F23H3"]))
    base_values.append(int(config["F23H4"]))
    # base_values.append(float(config["F23P3"]))
    base_values.append(int(config["F24H1"]))
    base_values.append(int(config["F24H2"]))
    base_values.append(int(config["F24H3"]))
    base_values.append(int(config["F24H4"]))
    ...
    function = 'CREATE TEMPORARY FUNCTION test(arr ARRAY<INT64>) RETURNS ARRAY<INT64> LANGUAGE js AS " ' \
               'let upper_sensitivity=' + upper_sensitivity + ';let lower_sensitivity=' + lower_sensitivity + ';let ' \
                                                                                                              'base=' + str(
        base_values) + ';for(let i=0;i<144;i++){if(arr[i] >= upper_sensitivity * base[i] || arr[i] <= base[i] * lower_sensitivity){arr[i]= ((arr[i]-base[i])/base[i])*100}else{arr[i]=0.0}}' \
                       'return arr;\";' \
                       ' '
