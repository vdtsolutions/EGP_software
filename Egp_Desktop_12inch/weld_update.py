...
class Query_flow():
    def __init__(self, runid, sensitivity):
        ...
        self.F19P3 = self.sensitivity * float(config["proximity19"])

        self.F20P4 = self.sensitivity * float(config["proximity20"])

        self.F21P1 = self.sensitivity * float(config["proximity21"])

        self.F22P2 = self.sensitivity * float(config["proximity22"])

        self.F23P3 = self.sensitivity * float(config["proximity23"])

        self.F24P4 = self.sensitivity * float(config["proximity24"])
    ...
    def query_flow(self):
        ...
        query_to_run = query.format(self.F1P1, self.F2P2, self.F3P3, self.F4P4, self.F5P1, self.F6P2, self.F7P3, self.F8P4, self.F9P1, self.F10P2, self.F11P3, self.F12P4, self.F13P1,
                                    self.F14P2, self.F15P3, self.F16P4, self.F17P1, self.F18P2, self.F19P3, self.F20P4, self.F21P1, self.F22P2, self.F23P3, self.F24P4, runid)
